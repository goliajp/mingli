...
impl CastingEngine for QimenEngine {
    ...
    fn profile(&self) -> &'static [DetItem] {
        ...
        const { &[
            ...
            d("格局·伏吟/反吟/三奇临吉门", Det, "伏吟 = 旋转 0 格（各归原位）、反吟 = 旋转 4 格（各落对冲宫），星门分判；干伏吟逐宫比对天地盘；三奇临吉门 = 天盘乙丙丁与开休生同宫。只出结构事实，吉凶判读交释义层"),
            d("其余格局（三奇得使/青龙返首/飞鸟跌穴/大小格等 200+ 条）", Und, "各家收录与成立条件出入较大，逐条需多源，未收"),
