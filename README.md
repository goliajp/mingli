...
someone once did by hand into a command anyone can re-run: it plants 88 known faults
...
./scripts/guard-probe.sh   # plants 88 known faults, checks the guard that should catch each one does
```
