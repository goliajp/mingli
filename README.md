...
someone once did by hand into a command anyone can re-run: it plants 112 known faults
...
./scripts/guard-probe.sh   # plants 112 known faults, checks the guard that should catch each one does
```
