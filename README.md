...
someone once did by hand into a command anyone can re-run: it plants 107 known faults
...
./scripts/guard-probe.sh   # plants 107 known faults, checks the guard that should catch each one does
```
