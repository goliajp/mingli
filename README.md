...
someone once did by hand into a command anyone can re-run: it plants 62 known faults
...
./scripts/guard-probe.sh   # plants 62 known faults, checks the guard that should catch each one does
```
