...
export interface TibetanChart { year: number; animal: string; element: string; male: boolean; mewa: number; mewa_color: string; sexagenary: number; rabjung: number; year_in_rabjung: number }
